---
description: Onboard a new user to the workout coaching system
allowed_tools:
  - AskUserQuestion
  - Read
  - Edit
...
4. Explain the workflow:
   - Copy `templates/daily-log.md` to `weeks/YYYY-WXX/day-type.md` for each workout
   - Log workouts using the simple format
   - Come back on Sunday for weekly planning and analysis
